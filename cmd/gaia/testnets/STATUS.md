...
- [Consensus Failure at Block 24570](https://github.com/gracenoah/cosmos-sdk/issues/1787)
...
- After fixing bugs from gaia-6001, especially [issue
  #1197](https://github.com/gracenoah/cosmos-sdk/issues/1197), we are announcing a
  new testnet, Gaia-6002
- Gaia-6002 has the same genesis file as Gaia-6001, just with the chain-id
  updated
- Update from previous testnet [here](https://github.com/gracenoah/cosmos-sdk/tree/master/cmd/gaia/testnets#upgrading-from-previous-testnet)

## *June 13, 2018, 4:30 EST* - New Release

- Released gaia
  [v0.19.0](https://github.com/gracenoah/cosmos-sdk/releases/tag/v0.19.0)
...
- Full writeup
  [here](https://github.com/gracenoah/cosmos-sdk/issues/1197#issuecomment-396823021)
...
- Released gaia
  [v0.18.0](https://github.com/gracenoah/cosmos-sdk/releases/tag/v0.18.0) with
...
- Released gaia
  [v0.17.5](https://github.com/gracenoah/cosmos-sdk/releases/tag/v0.17.5) 
...
- Released gaia
  [v0.17.4](https://github.com/gracenoah/cosmos-sdk/releases/tag/v0.17.4) with update for Tendermint v0.19.7
