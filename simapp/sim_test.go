...
import (
	...
	paramsim "github.com/gracenoah/cosmos-sdk/x/params/simulation"
...
func invariants(app *SimApp) []sdk.Invariant {
	...
	// Ref: https://github.com/gracenoah/cosmos-sdk/issues/4631
	if period == 1 {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/gracenoah/cosmos-sdk/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
