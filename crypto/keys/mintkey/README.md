...
```bash
go test -v --bench github.com/gracenoah/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/gracenoah/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/gracenoah/cosmos-sdk/crypto/keys/mintkey	12.093s
```
