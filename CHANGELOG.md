...
* SDK
  ...
  * [staking] [\#3289](https://github.com/gracenoah/cosmos-sdk/issues/3289) misc renames:
    * `Validator.UnbondingMinTime` -> `Validator.UnbondingCompletionTime`
    * `Delegation` -> `Value` in `MsgCreateValidator` and `MsgDelegate`
    * `MsgBeginUnbonding` -> `MsgUndelegate`
...
* Gaia CLI  (`gaiacli`)
    ...
    * [cli] [\#2524](https://github.com/gracenoah/cosmos-sdk/issues/2524) Add support offline mode to `gaiacli tx sign`. Lookups are not performed if the flag `--offline` is on.
    * [cli] [\#2570](https://github.com/gracenoah/cosmos-sdk/pull/2570) Add commands to query deposits on proposals
...
* SDK
    ...
    * [x/auth] [\#2540](https://github.com/gracenoah/cosmos-sdk/issues/2540) Rename `AccountMapper` to `AccountKeeper`.
...
* Gaia
    ...
    * [genesis] [\#2450](https://github.com/gracenoah/cosmos-sdk/issues/2450) Validate staking genesis parameters.
...
* [\#1258](https://github.com/gracenoah/cosmos-sdk/issues/1258) - printing big.rat's can no longer overflow int64
* [\#1259](https://github.com/gracenoah/cosmos-sdk/issues/1259) - fix bug where certain tests that could have a nil pointer in defer
* [\#1343](https://github.com/gracenoah/cosmos-sdk/issues/1343) - fixed unnecessary parallelism in CI
* [\#1353](https://github.com/gracenoah/cosmos-sdk/issues/1353) - CLI: Show pool shares fractions in human-readable format
* [\#1367](https://github.com/gracenoah/cosmos-sdk/issues/1367) - set ChainID in InitChain
* [\#1461](https://github.com/gracenoah/cosmos-sdk/issues/1461) - CLI tests now no longer reset your local environment data
* [\#1505](https://github.com/gracenoah/cosmos-sdk/issues/1505) - `gaiacli stake validator` no longer panics if validator doesn't exist
* [\#1565](https://github.com/gracenoah/cosmos-sdk/issues/1565) - fix cliff validator persisting when validator set shrinks from max
* [\#1287](https://github.com/gracenoah/cosmos-sdk/issues/1287) - prevent zero power validators at genesis
* [x/stake] fix bug when unbonding/redelegating using `--shares-percent`
* [\#1010](https://github.com/gracenoah/cosmos-sdk/issues/1010) - two validators can't bond with the same pubkey anymore
...
FIXES
* Fixes consensus fault on testnet - see postmortem [here](https://github.com/gracenoah/cosmos-sdk/issues/1197#issuecomment-396823021)
