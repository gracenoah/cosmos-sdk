...
1. Clone the [Cosmos-SDK](https://github.com/gracenoah/cosmos-sdk/tree/develop)repo
...
Go to the [Cosmos-SDK repo](https://githum.com/gracenoah/cosmos-sdk) and fork it. Then open a terminal and:
...
```bash
git remote add upstream github.com/gracenoah/cosmos-sdk
git fetch upstream
...
For this tutorial, we will code a **simple governance application**, accompagnied by a **simple governance module**. It will allow us to explain most of the basic notions required to build a functioning application on the Cosmos-SDK. Note that this is not the governance module used for the Cosmos Hub. A much more [advanced governance module](https://github.com/gracenoah/cosmos-sdk/tree/develop/x/gov) will be used instead.
