...
The Rest Server, also called [Light-Client Daemon (LCD)](https://github.com/gracenoah/cosmos-sdk/tree/master/client/lcd), provides support for **HTTP queries**.
