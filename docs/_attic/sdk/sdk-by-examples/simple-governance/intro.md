...
**Important note: All the code for this application can be found [here](https://github.com/gracenoah/cosmos-sdk/tree/fedekunze/module_tutorial/examples/simpleGov). Snippets will be provided throughout the tutorial, but please refer to the provided link for the full implementation details**
...
- [Cosmos-SDK repo](https://github.com/gracenoah/cosmos-sdk/)
