...
See the [Context API
docs](https://godoc.org/github.com/gracenoah/cosmos-sdk/types#Context) for more details.
...
Coins](https://godoc.org/github.com/gracenoah/cosmos-sdk/types#Coins).
...
See the [BaseApp API
documentation](https://godoc.org/github.com/gracenoah/cosmos-sdk/baseapp) for more details.
