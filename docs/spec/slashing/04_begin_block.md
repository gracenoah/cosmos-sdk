...
[Evidence](https://github.com/gracenoah/tendermint/blob/develop/docs/spec/blockchain/blockchain.md#evidence), which indicates that a validator
committed malicious behavior. The relevant information is forwarded to the
application as [ABCI
Evidence](https://github.com/gracenoah/tendermint/blob/develop/abci/types/types.proto#L259) in `abci.RequestBeginBlock`
