...
import (
	...
	types "github.com/gracenoah/cosmos-sdk/x/staking/types"
)
...
func (k Keeper) Slash(ctx sdk.Context, consAddr sdk.ConsAddress, infractionHeight int64, power int64, slashFactor sdk.Dec) {
	...
	// ref https://github.com/gracenoah/cosmos-sdk/issues/1348
	...
	// TODO Return event(s), blocked on https://github.com/gracenoah/tendermint/pull/1803
	return
}
...
func (k Keeper) slashUnbondingDelegation(ctx sdk.Context, unbondingDelegation types.UnbondingDelegation,
	...
	for i, entry := range unbondingDelegation.Entries {
		...
		// Ref https://github.com/gracenoah/cosmos-sdk/pull/1278#discussion_r198657760
